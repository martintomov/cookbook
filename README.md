...
- [Machine Learning Engineering](https://leanpub.com/MLE) by Andriy Burkov
...
- [Zero to GPT - A Guide](https://github.com/VikParuchuri/zero_to_gpt)
- [Andrej Karpathy - Let's build GPT: from scratch, in code, spelled out](https://youtu.be/kCc8FmEb1nY?si=99XpmIF_QqsIci1s)
